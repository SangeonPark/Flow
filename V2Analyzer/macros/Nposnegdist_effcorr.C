...
void Nposnegdist_effcorr()
{
   ...
   TH2D* h_epos_neg_temp = (TH2D*)f->Get("demo/Nneg_scatterHist_effcorr");
...
//   TLatex* text_b = makeLatex("EPOS",0.7,0.85) ;
   ...
   TH2D* h_hydjet_neg_temp = (TH2D*)f->Get("demo/Nneg_scatterHist_effcorr");
...
//base->Draw();
   ...
   hydjet_neg->Draw("same");
      ...
      SaveCanvas(c1,"pics","NscatterhistHydjet_effcor");
