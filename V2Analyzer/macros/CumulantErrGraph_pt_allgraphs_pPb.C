...
void CumulantErrGraph_pt_allgraphs_pPb(){
	...
	double setrange_low[5] = {0.85, 0.86, 0.87 ,0.872, 0.873};
	double setrange_upp[5] = {0.875,0.88, 0.89 ,0.895,  0.90};
	...
	TFile *rebinned = new TFile(Form("~/Summer2016/root_forgraphs/pt_pPb_%d_%d.root",mult_start[num],mult_end[num]),"RECREATE");
...
*/
 ...
 //   TCanvas* c2 = new TCanvas("c2","c2");
	...
	c3->Print(Form("~/Summer2016/pics/pt_pPb_%d_%d.pdf",mult_start[num],mult_end[num]));
	c3->Print(Form("~/Summer2016/pics/pt_pPb_%d_%d.gif",mult_start[num],mult_end[num]));
