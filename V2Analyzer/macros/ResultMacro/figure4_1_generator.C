...
void figure4_1_generator(){
	...
	for (Int_t i = 0; i < NAchBins; i++){
		...
		c2_pos[i][0] = (TH1D*)f->Get(Form("demo_n9/c2pos_%d_cos",i));
		c2_pos[i][1] = (TH1D*)f->Get(Form("demo_n9/c2pos_%d_sin",i));

		c2_neg[i][0] = (TH1D*)f->Get(Form("demo_n9/c2neg_%d_cos",i));
		c2_neg[i][1] = (TH1D*)f->Get(Form("demo_n9/c2neg_%d_sin",i));
...
//negative
	...
	base->GetYaxis()->SetRangeUser(0.09, 0.12);
	...
	TFile *rebinned = new TFile("~/Summer2016/root_forgraphs/figure4_1_notcorrected.root","RECREATE");
