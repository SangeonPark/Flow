...
void selfcorr_SP_avgpt(){
	...
	TFile *f = new TFile("../../../rootfiles/selfcorrelation/SP/selfcorr_40.root");
	...
	for (Int_t i = 0; i < NAchBins; i++){
		...
		pt_hist_negeta = (TH1D*)f->Get(Form("demo/pt_negeta_%d",i+1));
		pt_hist_poseta = (TH1D*)f->Get(Form("demo/pt_poseta_%d",i+1));
