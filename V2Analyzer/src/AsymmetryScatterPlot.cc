...
//list of c2 histograms
 	...
 	for (Int_t i = 0; i < NAchBins; i++){
 		...
 		c2_pos[i][0] = fs->make<TH1D>(Form("c2pos_%d_cos",i),"c2 Distribution",2000,-1.5,1.5);
 		c2_pos[i][1] = fs->make<TH1D>(Form("c2pos_%d_sin",i),"c2 Distribution",2000,-1.5,1.5);
 		c2_neg[i][0] = fs->make<TH1D>(Form("c2neg_%d_cos",i),"c2 Distribution",2000,-1.5,1.5);
 		c2_neg[i][1] = fs->make<TH1D>(Form("c2neg_%d_sin",i),"c2 Distribution",2000,-1.5,1.5);
 		gen_c2_pos[i][0] = fs->make<TH1D>(Form("gen_c2pos_%d_cos",i),"gen c2 Distribution",1000,-1.5,1.5);
 		gen_c2_pos[i][1] = fs->make<TH1D>(Form("gen_c2pos_%d_sin",i),"gen c2 Distribution",1000,-1.5,1.5);
 		gen_c2_neg[i][0] = fs->make<TH1D>(Form("gen_c2neg_%d_cos",i),"gen c2 Distribution",1000,-1.5,1.5);
 		gen_c2_neg[i][1] = fs->make<TH1D>(Form("gen_c2neg_%d_sin",i),"gen c2 Distribution",1000,-1.5,1.5);
